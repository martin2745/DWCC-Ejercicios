function diasHastaFinalDeCurso(): number {
  ...
  console.log("Diferencia en milisegundos", finalDeCurso.getTime() - hoy.getTime());
...
function aniversarioEnFinDeSemana(): number[] {
  const tuAniversario: Date = new Date("2023-10-31");
...
const formatoUsuario4: string = prompt('Introduce el formato \n1 17/02/2016, \n2 Mércores, 17 de febreiro de 2016 \n3 Wednesday, February 17, 2016');
